...
def _build_commands(include_admin: bool, include_calories: bool) -> Dict[str, list[BotCommand]]:
    ru = [
        ...
        BotCommand(command="quick", description="Быстрая запись в журнал"),
    ...
    uk = [
        ...
        BotCommand(command="quick", description="Швидкий запис у щоденник"),
    ...
    en = [
        ...
        BotCommand(command="quick", description="Quick journal save"),
