...
_HELP_TEXTS = {
    "ru": (
        ...
        "🥇 Мотивация — выговориться, фокус 15 мин, начать заново\n"
        "🎬 Искать фильмы и сериалы\n"
        "🤖 Отвечать на вопросы (Premium)\n\n"
        "<b>Быстрый старт:</b>\n"
        "1. Нажми 📓 Журнал → напиши мысль\n"
        "2. Нажми ⏰ Напоминания → создай задачу\n"
        "3. Нажми 🥇 Мотивация → выбери что нужно\n"
        "4. Или просто напиши — бот подскажет куда\n\n"
        "<b>Советы:</b>\n"
        "• Потерялся? Нажми /start — вернёт в главное меню\n"
        "• Хочешь выйти из режима? Нажми /cancel\n"
        "• В любом месте работают кнопки ⬅️ Назад\n\n"
        "<b>Команды:</b>\n"
    ...
    "uk": (
        ...
        "🥇 Мотивація — виговоритись, фокус 15 хв, почати заново\n"
        ...
        "3. Натисни 🥇 Мотивація → обери що потрібно\n"
        "4. Або просто напиши — бот підкаже куди\n\n"
        "<b>Поради:</b>\n"
        "• Загубився? Натисни /start — повернеться в головне меню\n"
        "• Хочеш вийти з режиму? Натисни /cancel\n"
        "• Скрізь працюють кнопки ⬅️ Назад\n\n"
        "<b>Команди:</b>\n"
    ...
    "en": (
        ...
        "🥇 Motivation — speak out, focus 15 min, start over\n"
        "🎬 Search for movies and shows\n"
        "🤖 Answer questions (Premium)\n\n"
        "<b>Quick start:</b>\n"
        "1. Tap 📓 Journal → write a thought\n"
        "2. Tap ⏰ Reminders → create a task\n"
        "3. Tap 🥇 Motivation → pick what you need\n"
        "4. Or just type — the bot will guide you\n\n"
        "<b>Tips:</b>\n"
        "• Lost? Tap /start — returns to main menu\n"
        "• Want to exit a mode? Tap /cancel\n"
        "• ⬅️ Back buttons work everywhere\n\n"
        "<b>Commands:</b>\n"
