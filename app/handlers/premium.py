...
TEXTS: Dict[str, Dict[str, str]] = {
    ...
    "sub_not_found": {
        "ru": "Не вижу подписки. Нажми «Подписаться», затем «Проверить». Если всё равно не срабатывает — премиум можно оформить, оплатив картой или через Stars 💳✨",
        "uk": "Не бачу підписки. Натисни «Підписатися», потім «Перевірити». Якщо все одно не спрацьовує — преміум можна оформити, оплативши карткою або через Stars 💳✨",
        "en": "I can’t see your subscription. Tap “Subscribe”, then “Check”. If it still doesn’t work — you can get Premium by paying with card or via Stars 💳✨",
    },
    "trial_used": {
        "ru": "Бесплатный день уже использован. Чтобы пользоваться премиумом дальше, нужно оформить платную подписку — оплатить картой или через Stars 💳✨",
        "uk": "Безкоштовний день уже використано. Щоб і надалі користуватися преміумом, потрібно оформити платну підписку — оплатити карткою або через Stars 💳✨",
        "en": "Your free trial has already been used. To keep using Premium, please purchase a plan — pay by card or via Stars 💳✨",
    },
