                    ...
                    if l.startswith("msgid "):
                        ...
                        for l2 in lines:
                            if l2.startswith("msgstr "):
                                msgstr = unq(l2[6:].strip())
                                break
                            if l2.startswith('"'):
                                cont.append(unq(l2.strip()))
                            else:
                                break
                        if cont:
                            msgid += "".join(cont)
