...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("plan", sa.Enum("trial", "month", "year", "quarter", "lifetime", "topup", name="payment_plan"), nullable=False),
        sa.Column("status", sa.Enum("cancelled", "pending", "paid", "refunded", "failed", name="payment_status"), nullable=False),
